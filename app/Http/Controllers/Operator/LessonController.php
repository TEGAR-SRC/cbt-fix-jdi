...
class LessonController extends Controller
{
    ...
    public function index()
    {
        ...
        //render with inertia
        return inertia('Operator/Lessons/Index', [
            'lessons' => $lessons,
        ]);
    }
    ...
    {
        return inertia('Operator/Lessons/Create');
    }
    ...
    public function store(Request $request)
    {
        ...
        //redirect
        return redirect()->route('operator.lessons.index');
    }
    ...
    public function edit($id)
    {
        ...
        //render with inertia
        return inertia('Operator/Lessons/Edit', [
            'lesson' => $lesson,
        ]);
    }
