...
class AssignmentQuestionController extends Controller
{
    public function index(Assignment $assignment)
    {
        ...
        return inertia('Operator/Assignments/Questions/Index', [
    ...
    {
        return inertia('Operator/Assignments/Questions/Create', [
            'assignment' => $assignment,
        ]);
    }
    ...
    public function store(Request $request, Assignment $assignment)
    {
        ...
        return redirect()->route('operator.assignments.questions.index', $assignment)->with('success', 'Soal ditambahkan');
    }

    public function edit(Assignment $assignment, AssignmentQuestion $question)
    {
        return inertia('Operator/Assignments/Questions/Edit', [
            'assignment' => $assignment,
            'question' => $question,
        ]);
    }
    ...
    public function update(Request $request, Assignment $assignment, AssignmentQuestion $question)
    {
        ...
        return redirect()->route('operator.assignments.questions.index', $assignment)->with('success', 'Soal diperbarui');
    }

    public function destroy(Assignment $assignment, AssignmentQuestion $question)
    {
        $question->delete();
        return redirect()->route('operator.assignments.questions.index', $assignment)->with('success', 'Soal dihapus');
    }
}
