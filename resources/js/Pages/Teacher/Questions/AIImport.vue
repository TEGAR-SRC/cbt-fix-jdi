<template>
  <Head>
    <title>AI Import Soal - Guru</title>
  </Head>
  <div class="container-fluid mb-5 mt-5">
    <div class="row">
      <div class="col-md-12">
    <Link :href="`${basePath}/exams/${exam.id}`" class="btn btn-md btn-primary border-0 shadow mb-3" type="button"><i class="fa fa-long-arrow-alt-left me-2"></i> Kembali</Link>
    ...
    setup(props) {
      ...
      const generate = () => {
        loading.value = true;
          ...
          router.post(`${basePath}/exams/${props.exam.id}/questions/ai-import/generate`, form, {
          onSuccess: (page) => {
            loading.value = false;
      ...
      const confirmImport = () => {
        ...
        saving.value = true;
          router.post(`${basePath}/exams/${props.exam.id}/questions/ai-import/confirm`, { items: cleaned }, {
          preserveScroll: true,
          onSuccess: () => {
            saving.value = false;
