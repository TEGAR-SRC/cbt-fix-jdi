<template>
  <Head><title>Edit Tugas - Guru</title></Head>
  <div class="container-fluid mt-4 mb-5">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h4 class="mb-0">Edit Tugas</h4>
      <Link href="/teacher/assignments" class="btn btn-light">Kembali</Link>
    </div>
...
export default { layout: TeacherLayout, components:{Head,Link}, props:{ assignment:Object, lessons:Array, classrooms:Array }, setup(props){ const form=useForm({ title:props.assignment.title||'',description:props.assignment.description||'',lesson_id:props.assignment.lesson_id||'',classroom_id:props.assignment.classroom_id||'',due_at:props.assignment.due_at?props.assignment.due_at.replace(' ','T'):'',published_at:props.assignment.published_at?props.assignment.published_at.replace(' ','T'):'' }); const submit=()=> form.put(`/teacher/assignments/${props.assignment.id}`); return { form, submit }; } };
</script>
<style></style>
