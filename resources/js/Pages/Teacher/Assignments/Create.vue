<template>
  <Head><title>Buat Tugas - Guru</title></Head>
...
export default { layout: TeacherLayout, components:{Head,Link}, props:{ lessons:Array, classrooms:Array }, setup(){ const form=useForm({ title:'',description:'',lesson_id:'',classroom_id:'',due_at:'',published_at:'' }); const submit=()=> form.post('/teacher/assignments'); return { form, submit }; } };
</script>
<style></style>
