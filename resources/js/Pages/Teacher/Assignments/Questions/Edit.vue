<template>
  ...
  <div class="container-fluid mt-4 mb-5">
    <div class="d-flex justify-content-between align-items-center mb-3">
      ...
      <Link :href="`/teacher/assignments/${assignment.id}/questions`" class="btn btn-light">Kembali</Link>
    </div>
    <div class="card border-0 shadow"><div class="card-body">
      <form @submit.prevent="submit">
        ...
        <div class="mt-4 d-flex">
          ...
          <Link :href="`/teacher/assignments/${assignment.id}/questions`" class="btn btn-light">Batal</Link>
        </div>
      </form>
    </div></div>
  </div>
...
export default { layout: TeacherLayout, components:{Head,Link}, props:{ assignment:Object, question:Object, errors:Object }, setup(props){ const form=useForm({question:props.question.question||'',option_1:props.question.option_1||'',option_2:props.question.option_2||'',option_3:props.question.option_3||'',option_4:props.question.option_4||'',option_5:props.question.option_5||'',answer:props.question.answer||'',order:props.question.order||''}); const submit=()=>form.put(`/teacher/assignments/${props.assignment.id}/questions/${props.question.id}`); return {form,submit,processing:form.processing}; } }
</script>
<style></style>
