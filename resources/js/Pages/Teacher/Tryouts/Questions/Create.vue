<template>
  <Head><title>Tambah Soal Tryout - Guru</title></Head>
...
export default { layout: TeacherLayout, components:{Head,Link}, props:{ tryout:Object, errors:Object }, setup(props){ const form=useForm({ question:'', option_1:'', option_2:'', option_3:'', option_4:'', option_5:'', answer:'', order:'' }); const submit=()=> form.post(`/teacher/tryouts/${props.tryout.id}/questions`); return { form, submit }; } }
</script>
<style scoped></style>
