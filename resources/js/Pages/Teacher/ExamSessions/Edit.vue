<template>
  <Head>
    <title>Edit Sesi Ujian - Guru</title>
  </Head>
  <div class="container-fluid mb-5 mt-5">
    <div class="row">
      <div class="col-md-12">
  <Link :href="`${basePath}/exam-sessions`" class="btn btn-md btn-primary border-0 shadow mb-3" type="button"><i
...
export default {
  ...
  props: { errors: Object, exam_session: Object, exams: Array },
  setup(props) {
    const form = reactive({
    ...
    const submit = () => {
      router.put(`${basePath}/exam-sessions/${props.exam_session.id}`, { ...form });
    };
