<template>
  <Head><title>Buat Tryout</title></Head>
  <div class="container-fluid mb-5 mt-5">
    <div class="row">
      <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-3">
          <h3 class="mb-0">Buat Tryout</h3>
...
export default {
  ...
  setup() {
    const form = useForm({
      title: '', description: '', lesson_id: '', classroom_id: '', duration_minutes: 60, start_at: '', end_at: '', published_at: null
    });
    const publishNow = Vue.ref(false);
    function submit(){
      form.published_at = publishNow.value ? new Date().toISOString() : null;
      form.post('/admin/tryouts');
    }
