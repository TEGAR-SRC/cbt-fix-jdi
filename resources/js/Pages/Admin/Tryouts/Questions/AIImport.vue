<template>
  <Head>
    <title>AI Import Soal Tryout - Aplikasi Ujian Online</title>
  </Head>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card border-0 shadow">
          <div class="card-body">
            <h5><i class="fa fa-robot"></i> Import Soal Otomatis (AI) - Tryout</h5>
            <hr>
            ...
            <form v-if="!items.length" @submit.prevent="generate">
              <div class="row g-3">
                <div class="col-md-6">
                  ...
                  <input v-model="form.category" type="text" class="form-control" placeholder="mis. Matematika Dasar, Bahasa Inggris" required />
                </div>
                <div class="col-md-3">
...
export default {
  ...
  props: { tryout: Object, preview: Array, form: Object, error: String },
  setup(props){
