                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div v-if="imagePreview" class="mt-2">
                                                    <img :src="imagePreview" alt="Preview" style="max-height: 160px;" />
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div v-if="videoPreview" class="mt-2">
                                                    <video :src="videoPreview" controls style="max-width: 100%; max-height: 260px;"></video>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
    ...
    export default {
        ...
        setup(props) {
            ...
            const submit = () => {
                ...
                router.post(`/admin/exams/${props.exam.id}/questions/store`, fd, {
                    onSuccess: () => {
                        //show success alert
                        Swal.fire({
                            title: 'Success!',
