...
export default {
  ...
  props:{ assignment:Object, question:Object, errors:Object },
  setup(props){
    const form = useForm({ question: props.question.question || '', option_1: props.question.option_1 || '', option_2: props.question.option_2 || '', option_3: props.question.option_3 || '', option_4: props.question.option_4 || '', option_5: props.question.option_5 || '', answer: props.question.answer || '', order: props.question.order || '' });
    const submit = () => form.put(`/admin/assignments/${props.assignment.id}/questions/${props.question.id}`);
