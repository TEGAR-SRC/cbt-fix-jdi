<template>
    <Head>
        <title>Admin - Aplikasi Ujian Online</title>
    </Head>
            ...
            <div class="col-md-8">
                <div class="row">
                    <div class="col-md-3 col-12 mb-2">
                        <Link href="/admin/admins/create" class="btn btn-md btn-primary border-0 shadow w-100" type="button"><i
            ...
            <div class="col-md-12">
                <div class="card border-0 shadow">
                    <div class="card-body">
                        ...
                        <Pagination :links="admins.links" align="end" />
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const handleSearch = () => {
                router.get('/admin/admins', { q: search.value });
            };
