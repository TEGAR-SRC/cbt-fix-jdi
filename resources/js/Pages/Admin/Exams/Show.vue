            ...
            <div class="col-md-12">
                ...
                <div class="card border-0 shadow">
                    <div class="card-body">
                        ...
                        <Link :href="`/admin/exams/${exam.id}/questions/ai-import`" class="btn btn-md btn-warning border-0 shadow text-dark ms-2" type="button"><i class="fa fa-robot"></i> Import AI</Link>
                                ...
                                <tbody>
                                    <tr v-for="(question, index) in exam.questions.data" :key="index">
                                        ...
                                        <td>
                                            ...
                                            <div v-if="question.image_path" class="mt-2">
                                                <img :src="`/storage/${question.image_path}`" alt="Gambar Soal" style="max-width: 100%; max-height: 200px;" />
                                            </div>
                                            <div v-if="question.audio_path" class="mt-2">
                                                <audio :src="`/storage/${question.audio_path}`" controls></audio>
                                            </div>
                                            <div v-if="question.video_path" class="mt-2">
                                                <video :src="`/storage/${question.video_path}`" controls style="max-width: 100%; max-height: 200px;"></video>
                                            </div>
                                            <hr>
                                            <ol type="A">
