<template>
  <Head>
    <title>Laporan Nilai Ujian - Operator</title>
  </Head>
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-3 col-12">
            <a :href="`/operator/reports/export?exam_id=${form.exam_id}`" target="_blank" class="btn btn-success w-100 text-white"><i class="bi bi-file-earmark-excel"></i> Download Excel</a>
          </div>
        </div>
        <hr />
...
export default {
  ...
  setup() {
    ...
    const filter = () => {
      router.get('/operator/reports/filter', { exam_id: form.exam_id });
    };
