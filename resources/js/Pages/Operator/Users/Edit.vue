<template>
  <Head>
    <title>Edit Pengguna - Operator</title>
  </Head>
  <div class="container-fluid mb-5 mt-5">
    <div class="row">
      <div class="col-md-12">
        <Link href="/operator/users" class="btn btn-md btn-primary border-0 shadow mb-3" type="button">
          <i class="fa fa-long-arrow-alt-left me-2"></i> Kembali
        </Link>
        <div class="card border-0 shadow">
          <div class="card-body">
            <h5><i class="fa fa-user-shield"></i> Edit Pengguna</h5>
            <hr>
            <form @submit.prevent="submit">
              ...
              <div class="mb-4">
                ...
                <div v-if="errors.role" class="alert alert-danger mt-2">{{ errors.role }}</div>
              </div>
...
export default {
  ...
  setup(props) {
    ...
    const submit = () => {
      router.put(`/operator/users/${props.user.id}`, {
        name: form.name,
        email: form.email,
