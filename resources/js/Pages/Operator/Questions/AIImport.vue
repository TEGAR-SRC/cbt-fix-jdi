<template>
  <Head>
    <title>AI Import Soal - Operator</title>
  </Head>
  <div class="container-fluid mb-5 mt-5">
    <div class="row">
      <div class="col-md-12">
    <Link href="/operator/exams" class="btn btn-md btn-primary border-0 shadow mb-3" type="button"><i class="fa fa-long-arrow-alt-left me-2"></i> Kembali</Link>
  ...
  export default {
    ...
    setup(props) {
      ...
      const generate = () => {
        loading.value = true;
          router.post(`/operator/exams/${props.exam.id}/questions/ai-import/generate`, form, {
          onSuccess: (page) => {
            loading.value = false;
      ...
      const confirmImport = () => {
        ...
        saving.value = true;
          router.post(`/operator/exams/${props.exam.id}/questions/ai-import/confirm`, { items: cleaned }, {
          preserveScroll: true,
          onSuccess: () => {
            saving.value = false;
