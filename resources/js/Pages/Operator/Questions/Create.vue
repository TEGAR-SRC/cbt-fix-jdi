<template>
  <OperatorLayout>
    <div class="container-fluid py-4">
      <h4 class="fw-semibold mb-3">Tambah Soal</h4>
      <form @submit.prevent="submit">
        ...
        <div class="mt-4">
          ...
          <Link :href="`/operator/exams/${exam.id}`" class="btn btn-light ms-2">Batal</Link>
        </div>
      </form>
    </div>
  </OperatorLayout>
...
export default {
  ...
  props: { exam: Object },
  data(){
    return { form: { question:'', option_1:'', option_2:'', option_3:'', option_4:'', option_5:'', answer:'1' } }
  },
  methods:{
    submit(){ router.post(`/operator/exams/${this.exam.id}/questions`, this.form) }
  }
}
</script>
