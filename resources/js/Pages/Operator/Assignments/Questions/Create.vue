...
export default { layout: OperatorLayout, components:{Head,Link}, props:{ assignment:Object, errors:Object }, setup(props){ const form=useForm({question:'',option_1:'',option_2:'',option_3:'',option_4:'',option_5:'',answer:'',order:''}); const submit=()=>form.post(`/operator/assignments/${props.assignment.id}/questions`); return {form,submit,processing:form.processing}; } }
</script>
<style></style>
