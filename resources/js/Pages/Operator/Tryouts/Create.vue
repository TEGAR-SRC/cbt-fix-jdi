<template>
  <Head><title>Buat Tryout - Operator</title></Head>
      ...
      <div class="card-body">
        <form @submit.prevent="submit">
          ...
          <div class="form-check mb-3">
            <input class="form-check-input" type="checkbox" id="publishNowOperator" v-model="publishNow"/>
            <label class="form-check-label" for="publishNowOperator">Publikasikan sekarang</label>
          </div>
