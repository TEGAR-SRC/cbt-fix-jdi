<template>
  <Head><title>Edit Soal Tryout - Operator</title></Head>
  <div class="container-fluid mb-5 mt-4">
    <Link :href="`/operator/tryouts/${tryout.id}/questions`" class="btn btn-sm btn-outline-secondary mb-3"><i class="fa fa-long-arrow-alt-left me-1"/>Kembali</Link>
      ...
      <div class="card-body">
        ...
        <form @submit.prevent="submit">
          ...
          <div class="mt-4 d-flex gap-2">
            ...
            <Link :href="`/operator/tryouts/${tryout.id}/questions/${question.id}`" method="delete" as="button" class="btn btn-danger" confirm="Hapus soal ini?">Hapus</Link>
          </div>
        </form>
      </div>
    </div>
...
export default { layout: OperatorLayout, components:{Head,Link}, props:{ tryout:Object, question:Object, errors:Object }, setup(props){ const form=useForm({ question:props.question.question||'', option_1:props.question.option_1||'', option_2:props.question.option_2||'', option_3:props.question.option_3||'', option_4:props.question.option_4||'', option_5:props.question.option_5||'', answer:props.question.answer||'', order:props.question.order||'' }); const submit=()=> form.put(`/operator/tryouts/${props.tryout.id}/questions/${props.question.id}`); return { form, submit }; } }
</script>
<style scoped></style>
