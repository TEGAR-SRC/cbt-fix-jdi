<template>
  ...
  <div class="container-fluid mb-5 mt-5">
    <div class="row"><div class="col-md-12">
      <Link :href="`/operator/tryouts/${tryout.id}/questions`" class="btn btn-md btn-primary border-0 shadow mb-3 me-3"><i class="fa fa-long-arrow-alt-left me-2"/> Kembali</Link>
      ...
      <Link :href="`/operator/tryouts/${tryout.id}/questions/ai-import`" class="btn btn-md btn-warning border-0 shadow mb-3 text-white"><i class="fa fa-robot me-2"/> AI Import</Link>
...
export default { layout: OperatorLayout, components:{Head,Link}, props:{ tryout:Object, errors:Object }, setup(props){ const form=reactive({file:null}); const processing=false; const submit=()=>{ router.post(`/operator/tryouts/${props.tryout.id}/questions/import`, { file: form.file }, { forceFormData:true }); }; return { form, submit, processing }; } };
</script>
<style></style>
