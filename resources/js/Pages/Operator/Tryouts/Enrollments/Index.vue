  ...
  <div class="container-fluid mb-5 mt-4">
    ...
    <div class="card border-0 shadow"><div class="card-body">
      <div class="d-flex justify-content-between align-items-center mb-2">
        ...
        <Link :href="`/operator/tryouts/${tryout.id}/enrollments/create`" class="btn btn-sm btn-primary"><i class="fa fa-user-plus me-1"/> Tambah</Link>
      </div><hr class="mt-1"/>
        ...
        <table class="table table-bordered table-centered mb-0">
          ...
          <tbody>
            <tr v-for="(e,i) in enrollments.data" :key="e.id">
              ...
              <td><Link :href="`/operator/tryouts/${tryout.id}/enrollments/${e.id}`" method="delete" as="button" class="btn btn-sm btn-danger" confirm="Hapus?"><i class="fa fa-trash"/></Link></td>
            </tr>
          </tbody>
        </table>
      </div>
...
export default { layout: OperatorLayout, components:{Head,Link}, props:{ tryout:Object, enrollments:Object } }
</script>
<style scoped></style>
