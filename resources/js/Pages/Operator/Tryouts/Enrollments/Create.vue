<template>
  ...
  <div class="container-fluid mb-5 mt-4">
    <Link :href="`/operator/tryouts/${tryout.id}/enrollments`" class="btn btn-sm btn-outline-secondary mb-3"><i class="fa fa-long-arrow-alt-left me-1"/> Kembali</Link>
...
export default {
  ...
  setup(props){
    ...
    const submit=()=>{ form.post(`/operator/tryouts/${props.tryout.id}/enrollments`); };
