<template>
  <Head>
    <title>Pengaturan - Operator</title>
  </Head>
  <div class="container-fluid py-4">
    <div class="mb-4">
      <h4 class="fw-semibold mb-1">Pengaturan Sistem</h4>
      <div class="text-muted">Atur konfigurasi sistem ujian online</div>
    </div>
...
export default {
  ...
  setup(props){
    ...
    const submit = () => {
      ...
      router.post('/operator/settings', data);
    };
